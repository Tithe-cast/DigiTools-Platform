const products = [
  ...
  },
  {
    ...
    description: "Boost your website rankings with keyword research, audit tools, and backlink tracking.",
    price: 59,
    period: "monthly",
    tag: "Popular",
    tagType: "popular",
    features: ["Keyword research", "Site audit", "Backlink monitor"],
    icon: "🔍"
  },
  {
    id: 8,
    name: "Video Editor Cloud",
    description: "Professional video editing in your browser — no downloads, no limits.",
    price: 99,
    period: "yearly",
    tag: "New",
    tagType: "new",
    features: ["4K export", "100+ effects", "Team collaboration"],
    icon: "🎬"
  },
  {
    id: 9,
    name: "Email Campaign Manager",
    description: "Build, send, and track email campaigns that convert with smart automation.",
    price: 25,
    period: "monthly",
    tag: "Best Seller",
    tagType: "best-seller",
    features: ["Unlimited subscribers", "A/B testing", "Detailed analytics"],
    icon: "📧"
  }
];
